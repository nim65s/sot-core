...
/*! \class FeatureAbstract
  ...
  \image html pictures/feature.png "Feature diagram: Feature types derive from
  FeatureAbstract. Each feature has a reference of the same type and compute an
  error by comparing errorSIN signals from itself and from the reference."
  width=15cm
*/
class SOT_CORE_EXPORT FeatureAbstract : public Entity {
  ...
  */
  ...
  /*! \brief This vector specifies which dimension are used to perform the
    ...
    then the vector to specify is \f$ [ 0 1 0] \f$.*/
  ...
  /*! \brief This signal returns the Jacobian of the current value
    according to the robot state: \f$ J(t) = \frac{\delta{\bf s}^*(t)}{\delta
    {\bf q}(t)}\f$ */
  ...
  SOT_CORE_DEPRECATED virtual bool withErrorDot(void) const { return true; }
