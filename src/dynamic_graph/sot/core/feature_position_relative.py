...
class FeaturePositionRelative(Entity):
    ...
    def __init__(self,
        ...
        positions = ((basePosition, self._feature.signal('positionRef')), (otherPosition,
                                                                           self._feature.signal('position')),
                     (baseReference, self._reference.signal('positionRef')), (otherReference,
                                                                              self._reference.signal('position')))
        for (sout, sin) in positions:
